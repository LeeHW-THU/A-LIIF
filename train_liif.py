...
def make_data_loader(spec, tag=''):
    ...
    loader = DataLoader(dataset, batch_size=spec['batch_size'],
        shuffle=(tag == 'train'), num_workers=4, pin_memory=True,worker_init_fn=seed_worker)
    return loader
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config',default='configs/train-div2k/train_edsr-baseline-A-liif.yaml')
    parser.add_argument('--name', default='testALIIF')
